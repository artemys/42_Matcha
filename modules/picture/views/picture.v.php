...
if (isset($_GET['id']))
{
	...
	$img_owner = $_GET['id'];
	$user_profil = $usero->get_profils_owner_name($db, $img_owner);
	$user_profil = $user_profil . " 's profil";
}
else
{
	$img_owner = $_SESSION['user_id'];
	$user_profil = $user->get_profils_owner_name($db, $img_owner);
	$user_profil = "Hello ". $user_profil . " !";
}
?>
...
<section class="module" id="Picture">
	<section id="Userpictures">
			...
			<div style="float: right;" class="user_log" /><?php echo $user_profil; ?> </div>
		...
		<section class="body">
			...
			<section id='More'>
				<form method="post" action="index.php?nav=Home">
					<input id="DelPicture" 			  type="hidden" name="Del"         value="Delete" 		 title="Delete Picture">
					<input type="submit" name="del" value="Delete"/>
				</form>
				<form method="post" action="index.php?nav=Home">
					<input id="ChangePicturePriority" type="hidden" name="SetAsProfil" value="Set as profil" title="Set as profil" >
					<input type="submit" name="prio" value="Set as profil picture"/>
				</form>
			</section>
