...
try
{
  $sql_create_blocsignal_table = "CREATE TABLE `$DB_name`.`blocsignal`(
  `id`  INT( 11 ) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `bloc_id` INT( 11 ) NOT NULL,
  `user_id` INT( 11 ) NOT NULL,
  `type` VARCHAR( 22 ) NOT NULL)";
  $conn->exec($sql_create_blocsignal_table);
  echo "Table blocsignal created successfuly.\n";
}
catch(PDOException $e)
{
  echo $e->getMessage() . "\n";
